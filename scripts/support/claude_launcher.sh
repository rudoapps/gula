#!/bin/bash
# ─────────────────────────────────────────────────────────────────────────────
# claude_launcher.sh — Flujo de `gula` SIN argumentos:
...
#
# Reutiliza las variables de color globales de gula (GREEN, RED, YELLOW, DIM…).
# El pool se puede sobreescribir con la variable de entorno GULA_CLAUDE_POOL.
# ─────────────────────────────────────────────────────────────────────────────
...
_claude_pool_file() {
  if [ -n "${GULA_CLAUDE_POOL:-}" ]; then
    echo "$GULA_CLAUDE_POOL"
  else
